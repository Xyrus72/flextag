...
const CampaignTracker = () => {
  ...
  // Load orders, posts and private invitations
  useEffect(() => {
    const load = async () => {
      try {
        const [ordersData, postsData, invitedData] = await Promise.all([
          getOrders({ status: 'all' }),
          getPosts(),
          api.get('/api/campaigns/invited').then(res => res.data),
        ])

        const orders = ordersData.orders || []
        const posts = postsData.posts || []
        const invited = invitedData.campaigns || []

        // Save private campaign invitations
        setPrivateCampaigns(invited)
        ...
        const items = orders
          ...
          .map(o => {
            ...
            if (
              ...
              const retDeadline =
                new Date(post.retentionDeadline)

              const retDaysTotal =
                campaign?.retentionDays || 7

              const retDaysLeft = Math.max(
                0,
                (retDeadline.getTime() - now) / 86400000
              )
    ...
    <div className="page-root">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Track your orders and posting deadlines in real-time
        </p>
      </div>
      ...
      <div className="p-4 rounded-2xl bg-violet-500/5 border border-violet-500/15 mb-6 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            You'll receive email reminders at 48h, 24h, and 6h before each deadline.
          </p>
        </div>
          ...
          {privateCampaigns.length > 0 && (
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="px-2 py-1 rounded-full bg-violet-500/15 text-violet-400 border border-violet-500/20 text-[10px] font-bold">
                  {privateCampaigns.length} INVITE
                  {privateCampaigns.length > 1 ? 'S' : ''}
                </span>
                ...
                {privateCampaigns.map(campaign => (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      {/* PRODUCT ICON */}
                      <div className="w-14 h-14 rounded-xl bg-violet-500/10 flex items-center justify-center text-3xl flex-shrink-0">
                        📦
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="px-2 py-0.5 rounded-full bg-violet-500/15 text-violet-400 border border-violet-500/20 text-[9px] font-bold">
                            PRIVATE
                          </span>
          ...
          {campaigns.length === 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-sm text-zinc-600">
                Place orders from the catalog to get started
              </p>
            ...
            <div className="space-y-4">
              ...
              {campaigns.map(c => {
                ...
                const cd =
                  c.deadlineHours !== null &&
                  c.deadlineHours !== undefined
                    ? formatCountdown(c.deadlineHours)
                    : null
                ...
                return (
                  ...
                  <div
                    key={c.id}
                    className={`p-5 rounded-2xl border transition-all ${urgencyBg(c.deadlineHours)}`}
                  >
                        ...
                        {c.status === 'retention' ? (
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {[
                                ...
                                >
                                  ...
                                  <div
                                    className={`text-2xl font-extrabold font-mono ${urgencyColor(c.deadlineHours)}`}
                                  >
                            ...
                            {c.deadlineHours <= 6 && (
                              ...
                              <span className="px-3 py-1 rounded-full bg-red-500/15 text-red-400 text-xs font-bold animate-pulse">
                                ⚠ Urgent
                              </span>
